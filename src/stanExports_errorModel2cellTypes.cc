...
#include "stanExports_errorModel2cellTypes.h"

RCPP_MODULE(stan_fit4errorModel2cellTypes_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_errorModel2cellTypes")
