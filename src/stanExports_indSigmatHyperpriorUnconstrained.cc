...
#include "stanExports_indSigmatHyperpriorUnconstrained.h"

RCPP_MODULE(stan_fit4indSigmatHyperpriorUnconstrained_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_indSigmatHyperpriorUnconstrained")
