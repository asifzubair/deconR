...
#include "stanExports_indSigmatHyperprior.h"

RCPP_MODULE(stan_fit4indSigmatHyperprior_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_indSigmatHyperprior")
