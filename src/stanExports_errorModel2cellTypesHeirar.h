...
namespace model_errorModel2cellTypesHeirar_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_errorModel2cellTypesHeirar");
    reader.add_event(91, 89, "end", "model_errorModel2cellTypesHeirar");
    return reader;
}
#include <stan_meta_header.hpp>
class model_errorModel2cellTypesHeirar : public prob_grad {
private:
        int n;
        vector_d genotype;
        vector_d y;
        ...
        vector_d sd2;
public:
    model_errorModel2cellTypesHeirar(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_errorModel2cellTypesHeirar_namespace::model_errorModel2cellTypesHeirar";
    ...
    ~model_errorModel2cellTypesHeirar() { }
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(normal_log<propto__>(trueProp2, measProp2, sd2));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_errorModel2cellTypesHeirar_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    static std::string model_name() {
        return "model_errorModel2cellTypesHeirar";
    }
...
typedef model_errorModel2cellTypesHeirar_namespace::model_errorModel2cellTypesHeirar stan_model;
#endif
