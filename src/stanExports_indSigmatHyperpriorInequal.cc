...
#include "stanExports_indSigmatHyperpriorInequal.h"

RCPP_MODULE(stan_fit4indSigmatHyperpriorInequal_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_indSigmatHyperpriorInequal")
