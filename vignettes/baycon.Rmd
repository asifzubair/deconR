...
out1 <- baycon(bulkExpression = p_bulkExpressionSimMat, sigMat = p_simSigMatTwo, fit.mvn = T, 
...
out2 <- baycon(bulkExpression = p_bulkExpressionSimMat, sigMat = p_simSigMatTwo, fit.mvn = F, useHyperPrior = T,
               verbose = F, refresh = 0, control = list(adapt_delta = 0.95))
