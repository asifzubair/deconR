...
namespace model_errorModel2cellTypes_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_errorModel2cellTypes");
    reader.add_event(91, 89, "end", "model_errorModel2cellTypes");
    return reader;
}

#include <stan_meta_header.hpp>
 class model_errorModel2cellTypes : public prob_grad {
private:
        int n;
        vector_d genotype;
        vector_d y;
        ...
        vector_d sd2;
public:
    model_errorModel2cellTypes(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_errorModel2cellTypes_namespace::model_errorModel2cellTypes";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_errorModel2cellTypes_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    static std::string model_name() {
        return "model_errorModel2cellTypes";
    }
...
typedef model_errorModel2cellTypes_namespace::model_errorModel2cellTypes stan_model;
