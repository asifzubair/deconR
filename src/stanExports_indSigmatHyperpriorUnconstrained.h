...
namespace model_indSigmatHyperpriorUnconstrained_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_indSigmatHyperpriorUnconstrained");
    reader.add_event(92, 90, "end", "model_indSigmatHyperpriorUnconstrained");
    return reader;
}
#include <stan_meta_header.hpp>
class model_indSigmatHyperpriorUnconstrained : public prob_grad {
private:
        int numGenes;
        int numCellTypes;
        vector_d exprMixVec;
        ...
        vector_d alpha;
public:
    model_indSigmatHyperpriorUnconstrained(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_indSigmatHyperpriorUnconstrained_namespace::model_indSigmatHyperpriorUnconstrained";
    ...
    ~model_indSigmatHyperpriorUnconstrained() { }
    void transform_inits(const stan::io::var_context& context__,
        ...
        try {
            writer__.vector_lub_unconstrain(0, 1, estimatedProportionsVecSimp);
        } catch (const std::exception& e) {
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                estimatedProportionsVecSimp = in__.vector_lub_constrain(0, 1, numCellTypes, lp__);
            else
                estimatedProportionsVecSimp = in__.vector_lub_constrain(0, 1, numCellTypes);
            current_statement_begin__ = 53;
            local_scalar_t__ nu;
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_indSigmatHyperpriorUnconstrained_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        // read-transform, write parameters
        Eigen::Matrix<double, Eigen::Dynamic, 1> estimatedProportionsVecSimp = in__.vector_lub_constrain(0, 1, numCellTypes);
        size_t estimatedProportionsVecSimp_j_1_max__ = numCellTypes;
        for (size_t j_1__ = 0; j_1__ < estimatedProportionsVecSimp_j_1_max__; ++j_1__) {
    ...
    static std::string model_name() {
        return "model_indSigmatHyperpriorUnconstrained";
    }
...
typedef model_indSigmatHyperpriorUnconstrained_namespace::model_indSigmatHyperpriorUnconstrained stan_model;
#endif
